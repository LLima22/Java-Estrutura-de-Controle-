...
public class Multa {
    ...
    public String verifica(){
        if(this.rua==this.velo+10 || this.velo+10>this.rua){
            ...
            JOptionPane.showMessageDialog(null,"valor da multa é 50 reais");
            return ("");
            ...
            if(this.velo+11>this.rua && this.velo+30<rua){
                ...
                JOptionPane.showMessageDialog(null,"valor da multa é 100 reais");
                return ("");
            
            }else{
                
                JOptionPane.showMessageDialog(null,"valor da multa é 300 reais");
                return ("");
            }
        }
